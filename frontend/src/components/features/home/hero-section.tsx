      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link href={getBrandPath("/contact?type=visit")} className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="w-full bg-transparent border-white text-white hover:bg-white hover:text-black">
                Book Site Visit
              </Button>
            </Link>
            ...
            {whatsappUrl && (
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button size="lg" variant="secondary" className="w-full bg-[#25D366] text-black hover:bg-[#1DA851] border-none flex items-center gap-2">
